 ...
 */
public class StockBigVolumeAdapter  extends BaseAdapter{
    private Context mContext;
    private ArrayList<StockBigVolume> arrayStock=new ArrayList<>();

    public StockBigVolumeAdapter(Context mContext) {
        this.mContext=mContext;
    }

    public StockBigVolumeAdapter(Context mContext, ArrayList<StockBigVolume> arrayStock) {
        this.mContext=mContext;

 ...
 */
public class FragmentCashFlow extends Fragment {
    private View mMainView;
    private ListView lvBigVolume;
    private StockBigVolumeAdapter adapterTop;

    public static FragmentCashFlow newInstance() {
        Bundle args = new Bundle();
        FragmentCashFlow fragment = new FragmentCashFlow();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mMainView = inflater.inflate(R.layout.fragment_cash_flow, null);
